    ...
    <main class="flex-1 p-4 md:p-6">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-8 md:mb-12">
          ...
          <h2 class="text-2xl md:text-3xl font-bold text-[var(--sg-text)] mb-3 md:mb-4">How can we help you?</h2>
          <p class="text-base md:text-xl text-[var(--sg-text-muted)] max-w-2xl mx-auto px-4 md:px-0">
        ...
        <div class="mb-8">
          <div class="flex justify-center">
            <div class="bg-[var(--sg-bg-1)] rounded-lg p-1 md:p-2 shadow-lg border w-full md:w-auto">
              <div class="grid grid-cols-2 md:flex md:space-x-1">
                <button
                  ...
                  class="px-3 py-2 md:px-6 md:py-3 rounded-lg text-xs md:text-sm font-semibold transition-colors flex items-center justify-center whitespace-nowrap
                    {activeTab === 'support'
                      ? 'bg-[var(--sg-accent-button)] text-white shadow-md'
                      : 'text-[var(--sg-text-dim)] hover:text-[var(--sg-text)] hover:bg-[var(--sg-bg-2)]'}"
                >
        ...
        {#if activeTab === 'support'}
          ...
          <div class="mb-8">
            <div class="text-center mb-8">
              <h3 class="text-2xl font-bold text-[var(--sg-text)] mb-4">Technical Support</h3>
              <p class="text-lg text-[var(--sg-text-muted)] max-w-2xl mx-auto">
            ...
            <div class="card-bg rounded-lg shadow-lg border p-4 md:p-6 lg:p-8 max-w-3xl mx-auto">
              <!-- Email Option -->
              <div class="bg-[var(--sg-accent-bg)] border border-[var(--sg-accent)] rounded-lg p-4 mb-6">
                <div class="flex items-start">
                  ...
                  <div>
                    <p class="font-medium text-[var(--sg-accent)]">Prefer Email?</p>
              ...
              <!-- Success Message -->
              {#if submitSuccess}
                <div class="bg-[var(--sg-success-bg)] border border-[var(--sg-success)] rounded-lg p-4 mb-6">
                  <div class="flex items-start">
                    <svg class="w-5 h-5 text-[var(--sg-success)] mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <div>
                      <p class="font-medium text-[var(--sg-success)]">Support request submitted successfully!</p>
                      <p class="text-sm text-[var(--sg-success)]">
              ...
              <!-- Error Message -->
              {#if submitError}
                <div class="bg-[var(--sg-error-bg)] border border-[var(--sg-error)] rounded-lg p-4 mb-6">
                  <div class="flex items-start">
                    <svg class="w-5 h-5 text-[var(--sg-error)] mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-2.694-.833-3.464 0L3.34 16.5c-.77.833.192 2.5 1.732 2.5z" />
                    </svg>
                    <div>
                      <p class="font-medium text-[var(--sg-error)]">Failed to submit support request</p>
                      <p class="text-sm text-[var(--sg-error)]">
                        {submitError}
                      </p>
                    </div>
                  </div>
              ...
              <form on:submit={handleSubmitSupport} class="space-y-6">
                <!-- Email -->
                <div>
                  <label for="email" class="block text-sm font-medium text-[var(--sg-text-muted)] mb-2">Your Email Address</label>
                  <input
                    type="email"
                    id="email"
                    ...
                    required
                    class="w-full px-4 py-3 border border-[var(--sg-border)] rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--sg-accent)] focus:border-transparent bg-[var(--sg-bg-1)] text-[var(--sg-text)] placeholder-[var(--sg-text-dim)]"
                  />
                </div>

                <!-- Priority -->
                <div>
                  <label for="priority" class="block text-sm font-medium text-[var(--sg-text-muted)] mb-2">Priority</label>
                  <select
                    id="priority"
                    bind:value={formData.priority}
                    class="w-full px-4 py-3 border border-[var(--sg-border)] rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--sg-accent)] focus:border-transparent bg-[var(--sg-bg-1)] text-[var(--sg-text)]"
                  >
                ...
                <!-- Subject -->
                <div>
                  <label for="subject" class="block text-sm font-medium text-[var(--sg-text-muted)] mb-2">Subject</label>
                  <input
                    type="text"
                    id="subject"
                ...
                <!-- Message -->
                <div>
                  <label for="message" class="block text-sm font-medium text-[var(--sg-text-muted)] mb-2">Message</label>
                  <textarea
                    id="message"
                    ...
                    required
                    rows="6"
                    class="w-full px-4 py-3 border border-[var(--sg-border)] rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--sg-accent)] focus:border-transparent bg-[var(--sg-bg-1)] text-[var(--sg-text)] placeholder-[var(--sg-text-dim)] resize-vertical"
                  ></textarea>
                </div>
        ...
        {:else if activeTab === 'community'}
          <!-- Community Section -->
          <div class="mb-8">
            <div class="bg-[var(--sg-bg-2)] rounded-lg p-6 md:p-8 border border-[var(--sg-border-light)] max-w-3xl mx-auto">
              <div class="text-center mb-6">
                <h3 class="text-lg md:text-xl lg:text-2xl font-bold text-[var(--sg-text)] mb-3 md:mb-4">Join Our Slack Community</h3>
                ...
                <p class="text-sm md:text-base lg:text-lg text-[var(--sg-text)]">
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-6 mt-8 max-w-4xl mx-auto">
              ...
              <div class="card-bg rounded-lg p-6 md:p-8 shadow border text-center">
                ...
                <h4 class="text-xl font-bold text-[var(--sg-text)] mb-4">GitHub Issues</h4>
              ...
              <div class="card-bg rounded-lg p-6 md:p-8 shadow border text-center">
                ...
                <h4 class="text-xl font-bold text-[var(--sg-text)] mb-4">GitHub Discussions</h4>
                <p class="text-[var(--sg-text-muted)] mb-6">
        ...
        {:else if activeTab === 'resources'}
          ...
          <div class="mb-8">
            <div class="text-center mb-8">
              <h3 class="text-2xl font-bold text-[var(--sg-text)] mb-4">Documentation & Resources</h3>
              <p class="text-lg text-[var(--sg-text-muted)] max-w-2xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-6 max-w-4xl mx-auto">
              ...
              <div class="card-bg rounded-lg p-6 md:p-8 shadow border text-center">
                ...
                <h4 class="text-xl font-bold text-[var(--sg-text)] mb-4">Documentation</h4>
                <p class="text-[var(--sg-text-muted)] mb-6">
              ...
              <div class="card-bg rounded-lg p-6 md:p-8 shadow border text-center">
                ...
                <h4 class="text-xl font-bold text-[var(--sg-text)] mb-4">Schedule a Call</h4>
                <p class="text-[var(--sg-text-muted)] mb-6">
        ...
        {:else if activeTab === 'status'}
          ...
          <div class="mb-8">
            <div class="text-center mb-8">
              <h3 class="text-2xl font-bold text-[var(--sg-text)] mb-4">Service Status</h3>
              <p class="text-lg text-[var(--sg-text-muted)] max-w-2xl mx-auto">
            ...
            <div class="card-bg rounded-lg shadow-lg border p-6 md:p-8 max-w-3xl mx-auto text-center">
              ...
              <h4 class="text-lg md:text-xl font-bold text-[var(--sg-text)] mb-3 md:mb-4">Real-time Service Status</h4>
              <p class="text-sm md:text-base text-[var(--sg-text-muted)] mb-4 md:mb-6">
