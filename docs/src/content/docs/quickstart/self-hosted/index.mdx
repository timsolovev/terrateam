...
The self-hosted Docker and Kubernetes deployments use the Open Source edition by default. For enterprise features like RBAC, Centralized Configuration, and Gatekeeper, see our [Editions and Licensing](/editions/) guide.
:::
